...
| ID   | Descrição                                                                                                             | Rastreabilidade      | Categoria | Classificação | Tipo        |
| ---- | --------------------------------------------------------------------------------------------------------------------- | -------------------- | --------- | ------------- | ----------- |
| [RQ15](../elicitação/requisitosElicitados.md) | Integrar bomboniere ao app para compra antecipada de itens e retirada rápida.                                          | [IS11](../elicitação/introspecção.md#IS11), [AI12](../elicitação/analiseUI.md#AI12)           | RF        | Indiferente         | Benefícios |
...
| ID   | Descrição                                                                                                             | Rastreabilidade      | Categoria | Classificação | Tipo           |
| ---- | --------------------------------------------------------------------------------------------------------------------- | -------------------- | --------- | ------------- | -------------- |
| [RQ02](../elicitação/requisitosElicitados.md)  | Detectar localização automaticamente e permitir alteração manual.                                                      | [IS02](../elicitação/introspecção.md#IS02), [AI02](../elicitação/analiseUI.md#AI02)            | RF        | Indiferente          | Personalização |
