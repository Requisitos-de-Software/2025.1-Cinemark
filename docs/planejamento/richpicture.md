...
---
<font size="3"><p style="text-align: center">Tabela 1: Cronograma da Validação do Rich Picture.</p></font>
...
O vídeo abaixo contém a validação do artefato do grupo. A gravação foi feita de forma presencial na Faculdade de Ciências e Tecnologia em Engenharias (FCTE).
...
A seguir apresentamos os nomes de cada integrante do grupo que participou da pré-rastreabilidade e suas respectivas contribuições.

<font size="3"><p style="text-align: center">Tabela 2: Participantes envolvidos na pré-rastreabilidade.</p></font>

| Nome                                                   | O que fez                 |
| ------------------------------------------------------ | ---------------------- |
|[Arthur Evangelista de Oliveira](https://github.com/arthurevg)| Produziu o Rich Picture da Carteira Digital de Trânsito (figuras 7 e 8). |
|[Davi Camilo Menezes](https://github.com/Davicamilo23)| Produziu o Rich Picture do IBGE (figuras 3 e 4), adicionou a tabela de contribuição dos membros, revisou o artefato para a entrega final e fez as alterações necessárias. |
|[Euller Júlio da Silva](https://github.com/Potatoyz908)| Produziu o Rich Picture da Carteira de Trabalho Digital (figuras 11 e 12). |
...
|[Artur de Camargos Rodrigues](https://github.com/ArturDCR)| Produziu o Rich Picture da cheers (figuras 13 e 14). |
...
### Cheers
<font size="3"><p style="text-align: center">Figura 13: *Rich Picture* versão 1.4.</p></font>
![](../assets/richpicturesavaliados/Cheers.png)
<font size="3"><p style="text-align: center">Fonte: [Artur de Camargos Rodrigues](https://github.com/ArturDCR), 2025.</p></font>

<font size="3"><p style="text-align: center">Figura 14: Legenda do *Rich Picture* versão 1.4.</p></font>
![](../assets/richpicturesavaliados/LegendaCheers.png)
<font size="3"><p style="text-align: center">Fonte: [Artur de Camargos Rodrigues](https://github.com/ArturDCR), 2025.</p></font>
...
| `1.1`  |  04/05/2025 |  Atualização do Documento | [Davi Camilo](https://github.com/Davicamilo23) |  | [Davi Camilo](https://github.com/Davicamilo23) |
...
| `1.3`  |  07/07/2025 | Adição da tabela de contribuição e pequenas alterações gerais | [Davi Camilo](https://github.com/Davicamilo23) | [Artur de Camargos](https://github.com/ArturDCR)  |
| `1.4`  |  07/07/2025 | Adição da figura 13 e 14 | [Artur de Camargos Rodrigues](https://github.com/ArturDCR) | [Davi Camilo](https://github.com/Davicamilo23)  |
