...
| [Léxicos](https://requisitos-de-software.github.io/2025.1-Cinemark/modelagem/lexicos/)  | Estrutura textual que define os termos relevantes do domínio da aplicação, com significados, sinônimos, impactos e rastreabilidade. | Todos | Todos |
...
| Artefato                | Descrição                        | Autor(es)          | Revisor(es)                             |
|-------------------------|----------------------------------|--------------------|-----------------------------------------|
| [Histórias do Usuário](#) | Requisitos funcionais descritos do ponto de vista do usuário final. | Autor(es) | Revisor(es) |
| [Backlog do Produto](#) | Lista priorizada das funcionalidades a serem desenvolvidas, divididas em temas e épicos | Autor(es) | Revisor(es) |
| [NFR Framework](#) | Modelo para identificar e organizar requisitos não funcionais. | Autor(es) | Revisor(es) |
...
| Artefato                | Descrição                        | Autor(es)          | Revisor(es)                             |
|-------------------------|----------------------------------|--------------------|-----------------------------------------|
| [Lista de requisitos - Versão Oficial](#) | Refinamento dos requisitos e construção da lista oficial de requisitos elicitados | Autor(es) | Revisor(es) |
| [Elos de Rastreabilidade](#) | Identifica vínculos entre diferentes artefatos e requisitos do projeto segundo o Meta-modelo de Toranzo. | Autor(es) | Revisor(es) |
| [Forward-From](#) | Mapeia como cada requisito leva à criação de outros artefatos. | Autor(es) | Revisor(es) |
| [Backward-From](#) | Mostra de quais requisitos cada artefato se origina ou é derivado. | Autor(es) | Revisor(es) |
| [Matriz Geral](#) | Integra todos os requisitos, suas fontes e documentos/artefatos gerados a partir dele em uma visão consolidada. | Autor(es) | Revisor(es) |
| [Lista de Verificação](#)  | Lista de verificação para a entrega com itens elaborados pelos integrantes | Autor(es) | Revisor(es) |
