...
Abaixo se encontra a **inspeção** (versão 2.0) da entrega 6 do grupo. A inspeção (versão 2.0) foi realizada no dia 07/07/2025, sendo feita com base na [lista de verificação](https://requisitos-de-software.github.io/2025.1-Cinemark/verifica%C3%A7%C3%B5es/lista-verifica%C3%A7%C3%A3o-06/) (versão 2.0) da entrega 6.

---

## 🔗 Link da gravação

[Assista ao vídeo no YouTube](https://youtu.be/TtvNVismBuw)
...
### Tabela 4: Lista de Verificação — Elos de Rastreabilidade
