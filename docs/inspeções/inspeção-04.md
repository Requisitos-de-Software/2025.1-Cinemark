...
Abaixo se encontra a **inspeção** (versão 2.0) da entrega 4 do grupo. A inspeção (versão 2.0) foi realizada no dia 07/07/2025, sendo feita com base na [lista de verificação](https://requisitos-de-software.github.io/2025.1-Cinemark/verifica%C3%A7%C3%B5es/lista-verifica%C3%A7%C3%A3o-04/) (versão 2.0) da entrega 4.

---

## 🔗 Link da gravação

[Assista ao vídeo no YouTube](https://youtu.be/0b057SUPbik)

---

## Lista de Inspeção (Versão 2.0)

### Tabela 1: Lista de Inspeção — NFR Framework
...
### Tabela 2: Lista de Inspeção — Backlog
...
### Tabela 3: Lista de Inspeção — Histórias de Usuário
